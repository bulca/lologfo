<div class="page-header">
	<h1>Support<small>We are here to help.</small></h1>
</div>
<div class="row" id="powerwidgets">
	<div class="col-md-12 bootstrap-grid"> 
		<div class="powerwidget cold-grey" id="mytickets" data-widget-editbutton="false">
			<header>
				<h2>Tickets<small>My Tickets</small></h2>
			</header>
	                    ...
	                    <div class="col-md-11">
							<div class="right-content clearfix">
								<div class="big-icons-buttons clearfix margin-bottom">
									<a href="#" onclick="location.hash = '#'; location.hash = '#openTicket'; $('[name=topic]').focus(); return false;" class="btn btn-sm btn-primary"><i class="fa fa-envelope"></i>Open New Ticket</a>
